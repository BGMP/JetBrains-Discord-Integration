...
Download the [.zip](https://github.com/BGMP/JetBrains-Shiba-Integration/releases/download/1.1/JetBrains-Discord-Integration-1.0+3.zip) file of the latest release, then
